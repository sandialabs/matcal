...
# Solid Mechanics Region ----------------------------------
    begin adagio region solid_mechanics_region
      ...
      begin user output elem_avg
        include all blocks
         compute element avg_pressure as VOLUME WEIGHTED AVERAGE of element hydrostatic_stress
         compute element avg_vm as VOLUME WEIGHTED AVERAGE of element von_mises
         compute element avg_eqps as VOLUME WEIGHTED AVERAGE of element eqps
      end
      ...
      begin results output solid_mechanics_output
        ...
        nodal displacement(x) as U
        nodal displacement(y) as V
        nodal displacement(z) as W
