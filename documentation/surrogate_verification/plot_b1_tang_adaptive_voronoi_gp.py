r"""
Tang Verification: Adaptive Voronoi Gaussian Process Surrogate
=============================================================
...
WORKING_DIRECTORY = os.path.abspath("paper_tang_adaptive_voronoi_gp")
...
study.set_surrogate_save_filename(
    os.path.join(
        WORKING_DIRECTORY,
        "tang_adaptive_voronoi_gp_surrogate.joblib",
    )
)
...
print("Running adaptive Voronoi GP Tang verification.")
...
plot_convergence_history(
    ...
    filename="tang_adaptive_voronoi_gp_convergence.png",
...
plot_function_and_surrogate_error_at_counts(
    ...
    figure_directory=FIGURE_DIRECTORY,
    filename="tang_adaptive_voronoi_gp_error_fields.png",
    method_name="adaptive Voronoi GP",
    n_grid=150,
)
