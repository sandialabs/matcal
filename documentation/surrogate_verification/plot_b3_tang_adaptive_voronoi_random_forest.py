r"""
Tang Verification: Adaptive Voronoi Random Forest Surrogate
===========================================================
...
WORKING_DIRECTORY = os.path.abspath("paper_tang_adaptive_voronoi_random_forest")
...
study.set_surrogate_save_filename(
    os.path.join(
        WORKING_DIRECTORY,
        "tang_adaptive_voronoi_random_forest_surrogate.joblib",
    )
)
...
print("Running adaptive Voronoi random forest Tang verification.")
...
print_convergence_summary(
    "adaptive Voronoi random forest Tang",
    sample_counts,
    rmse_history,
    max_error_history,
)
...
plot_convergence_history(
    ...
    filename="tang_adaptive_voronoi_random_forest_convergence.png",
...
plot_function_and_surrogate_error_at_counts(
    ...
    figure_directory=FIGURE_DIRECTORY,
    filename="tang_adaptive_voronoi_random_forest_error_fields.png",
    method_name="adaptive Voronoi random forest",
    n_grid=150,
)
