...
.. "full_field_verification_examples/plot_b_scipy_gmls_interpolation_verification.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_full_field_verification_examples_plot_b_scipy_gmls_interpolation_verification.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_full_field_verification_examples_plot_b_scipy_gmls_interpolation_verification.py:
...
.. image-sg:: /full_field_verification_examples/images/sphx_glr_plot_b_scipy_gmls_interpolation_verification_001.png
   :alt: Measured Data (with noise)
   :srcset: /full_field_verification_examples/images/sphx_glr_plot_b_scipy_gmls_interpolation_verification_001.png
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /full_field_verification_examples/images/sphx_glr_plot_b_scipy_gmls_interpolation_verification_002.png
         :alt: $e_{{norm}}$ — Built-in scipy GMLS
         :srcset: /full_field_verification_examples/images/sphx_glr_plot_b_scipy_gmls_interpolation_verification_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /full_field_verification_examples/images/sphx_glr_plot_b_scipy_gmls_interpolation_verification_003.png
         :alt: $e_{{max}}$ — Built-in scipy GMLS
         :srcset: /full_field_verification_examples/images/sphx_glr_plot_b_scipy_gmls_interpolation_verification_003.png
         :class: sphx-glr-multi-img
...
.. image-sg:: /full_field_verification_examples/images/sphx_glr_plot_b_scipy_gmls_interpolation_verification_004.png
   ...
   :srcset: /full_field_verification_examples/images/sphx_glr_plot_b_scipy_gmls_interpolation_verification_004.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Weight matrix shape: (90000, 160000)
    Number of non-zeros: 3033420
    Sparsity: 0.999789
    Average non-zeros per target: 33.7
    Max percent error (direct W @ f): 1.2970%
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_b_scipy_gmls_interpolation_verification.ipynb <plot_b_scipy_gmls_interpolation_verification.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_b_scipy_gmls_interpolation_verification.py <plot_b_scipy_gmls_interpolation_verification.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_b_scipy_gmls_interpolation_verification.zip <plot_b_scipy_gmls_interpolation_verification.zip>`
