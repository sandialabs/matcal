...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="We are going to assess the sensitivity of  five objectives to the input parameters:">

.. only:: html

  .. image:: /full_field_study_verification_examples/images/thumb/sphx_glr_plot_a_objective_sensitivities_thumb.png
    :alt:

  :ref:`sphx_glr_full_field_study_verification_examples_plot_a_objective_sensitivities.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Objective Sensitivity Study</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="To begin we import the MatCal tools necessary for this study and import the data that will be used for the calibration.">

.. only:: html

  .. image:: /full_field_study_verification_examples/images/thumb/sphx_glr_plot_b_standard_calibration_verification_thumb.png
    :alt:

  :ref:`sphx_glr_full_field_study_verification_examples_plot_b_standard_calibration_verification.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Load Displacement Calibration Verification -  First Attempt</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="As we will see, this does not occur using the VFM tool with limited data.">

.. only:: html

  .. image:: /full_field_study_verification_examples/images/thumb/sphx_glr_plot_vfm_one_angle_calibration_verification_thumb.png
    :alt:

  :ref:`sphx_glr_full_field_study_verification_examples_plot_vfm_one_angle_calibration_verification.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Virtual Fields Calibration Verification</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="Since the problem setup and data manipulation is  nearly identical to Virtual Fields Calibration Verification,  we only add additional commentary and discussion on the  study results at the end.">

.. only:: html

  .. image:: /full_field_study_verification_examples/images/thumb/sphx_glr_plot_vfm_u_three_angles_calibration_verification_thumb.png
    :alt:

  :ref:`sphx_glr_full_field_study_verification_examples_plot_vfm_u_three_angles_calibration_verification.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Virtual Fields Calibration Verification - Three Data Sets</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="There are only two differences between this calibration and the  load-displacement calibration. ">

.. only:: html

  .. image:: /full_field_study_verification_examples/images/thumb/sphx_glr_plot_w_gradient_interp_calibration_verification_thumb.png
    :alt:

  :ref:`sphx_glr_full_field_study_verification_examples_plot_w_gradient_interp_calibration_verification.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Full-field Interpolation Calibration Verification</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="All other inputs and classes are the same for this calibration  as they are in the full-field interpolation objective example. As a result,  the commentary is mostly removed for this example except for some discussion on the results at the end.">

.. only:: html

  .. image:: /full_field_study_verification_examples/images/thumb/sphx_glr_plot_x_hwd_calibration_verification_thumb.png
    :alt:

  :ref:`sphx_glr_full_field_study_verification_examples_plot_x_hwd_calibration_verification.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Polynomial HWD with Point Colocation Calibration Verification</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="There are two differences in this calibration that allows it to be successful where the referenced example above fails. ">

.. only:: html

  .. image:: /full_field_study_verification_examples/images/thumb/sphx_glr_plot_y_gradient_interp_calibration_verification_thumb.png
    :alt:

  :ref:`sphx_glr_full_field_study_verification_examples_plot_y_gradient_interp_calibration_verification.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Full-field Interpolation Calibration Verification - Success!</div>
    </div>
...
.. only:: html
  ...
  .. image:: /full_field_study_verification_examples/images/thumb/sphx_glr_plot_z_hwd_calibration_verification_success_thumb.png
    :alt:

  :ref:`sphx_glr_full_field_study_verification_examples_plot_z_hwd_calibration_verification_success.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Polynomial HWD with Point Colocation Calibration Verification - 2nd Attempt</div>
    </div>
...
.. toctree::
   ...
   /full_field_study_verification_examples/plot_a_objective_sensitivities
   /full_field_study_verification_examples/plot_b_standard_calibration_verification
   /full_field_study_verification_examples/plot_vfm_one_angle_calibration_verification
   /full_field_study_verification_examples/plot_vfm_u_three_angles_calibration_verification
   /full_field_study_verification_examples/plot_w_gradient_interp_calibration_verification
   /full_field_study_verification_examples/plot_x_hwd_calibration_verification
   /full_field_study_verification_examples/plot_y_gradient_interp_calibration_verification
   /full_field_study_verification_examples/plot_z_hwd_calibration_verification_success
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-gallery
    ...
    .. container:: sphx-glr-download sphx-glr-download-python
      ...
      :download:`Download all examples in Python source code: full_field_study_verification_examples_python.zip </full_field_study_verification_examples/full_field_study_verification_examples_python.zip>`

    .. container:: sphx-glr-download sphx-glr-download-jupyter

      :download:`Download all examples in Jupyter notebooks: full_field_study_verification_examples_jupyter.zip </full_field_study_verification_examples/full_field_study_verification_examples_jupyter.zip>`
