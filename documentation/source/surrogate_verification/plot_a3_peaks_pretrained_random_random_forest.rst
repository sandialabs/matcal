...
.. "surrogate_verification/plot_a3_peaks_pretrained_random_random_forest.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_surrogate_verification_plot_a3_peaks_pretrained_random_random_forest.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_surrogate_verification_plot_a3_peaks_pretrained_random_random_forest.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Training pretrained random-sampling random forest with 20 samples.
    ...
    Training pretrained random-sampling random forest with 40 samples.
    /ascldap/users/knkarls/.conda/envs/pyapprox-base/lib/python3.12/site-packages/sklearn/base.py:1365: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
      return fit_method(estimator, *args, **kwargs)
      validation RMSE:               1.214557e+00
      validation max absolute error: 7.921387e+00

    Training pretrained random-sampling random forest with 50 samples.
    /ascldap/users/knkarls/.conda/envs/pyapprox-base/lib/python3.12/site-packages/sklearn/base.py:1365: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
      return fit_method(estimator, *args, **kwargs)
      validation RMSE:               1.228790e+00
      validation max absolute error: 8.237979e+00

    Training pretrained random-sampling random forest with 60 samples.
    /ascldap/users/knkarls/.conda/envs/pyapprox-base/lib/python3.12/site-packages/sklearn/base.py:1365: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
      return fit_method(estimator, *args, **kwargs)
      validation RMSE:               1.145730e+00
      validation max absolute error: 8.227249e+00

    Training pretrained random-sampling random forest with 80 samples.
    /ascldap/users/knkarls/.conda/envs/pyapprox-base/lib/python3.12/site-packages/sklearn/base.py:1365: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
      return fit_method(estimator, *args, **kwargs)
      validation RMSE:               1.059909e+00
      validation max absolute error: 7.334305e+00

    Training pretrained random-sampling random forest with 100 samples.
    /ascldap/users/knkarls/.conda/envs/pyapprox-base/lib/python3.12/site-packages/sklearn/base.py:1365: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
      return fit_method(estimator, *args, **kwargs)
      validation RMSE:               1.104269e+00
      validation max absolute error: 7.627928e+00

    Training pretrained random-sampling random forest with 120 samples.
    /ascldap/users/knkarls/.conda/envs/pyapprox-base/lib/python3.12/site-packages/sklearn/base.py:1365: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
      return fit_method(estimator, *args, **kwargs)
      validation RMSE:               1.107210e+00
      validation max absolute error: 7.531137e+00

    Training pretrained random-sampling random forest with 140 samples.
    /ascldap/users/knkarls/.conda/envs/pyapprox-base/lib/python3.12/site-packages/sklearn/base.py:1365: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
      return fit_method(estimator, *args, **kwargs)
      validation RMSE:               1.045077e+00
      validation max absolute error: 7.381469e+00

    Training pretrained random-sampling random forest with 150 samples.
    /ascldap/users/knkarls/.conda/envs/pyapprox-base/lib/python3.12/site-packages/sklearn/base.py:1365: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n_samples,), for example using ravel().
      return fit_method(estimator, *args, **kwargs)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pretrained random-sampling random forest convergence summary:
...
.. image-sg:: /surrogate_verification/images/sphx_glr_plot_a3_peaks_pretrained_random_random_forest_001.png
   :alt: Peaks verification: pretrained random-sampling random forest
   :srcset: /surrogate_verification/images/sphx_glr_plot_a3_peaks_pretrained_random_random_forest_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (<Figure size 750x520 with 1 Axes>, <Axes: title={'center': 'Peaks verification: pretrained random-sampling random forest'}, xlabel='number of training samples', ylabel='validation error'>)
...
.. image-sg:: /surrogate_verification/images/sphx_glr_plot_a3_peaks_pretrained_random_random_forest_002.png
   :alt: Peaks verification: pretrained random-sampling random forest, True Peaks function N=50, True Peaks function N=100, True Peaks function N=150, Absolute surrogate error N=50, field max=9.510e+00, Absolute surrogate error N=100, field max=7.646e+00, Absolute surrogate error N=150, field max=7.498e+00
   :srcset: /surrogate_verification/images/sphx_glr_plot_a3_peaks_pretrained_random_random_forest_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Figures saved to: /gpfs/knkarls/projects/matcal_devel/external_matcal/documentation/surrogate_verification/paper_peaks_pretrained_random_random_forest/figures
...
.. _sphx_glr_download_surrogate_verification_plot_a3_peaks_pretrained_random_random_forest.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_a3_peaks_pretrained_random_random_forest.ipynb <plot_a3_peaks_pretrained_random_random_forest.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_a3_peaks_pretrained_random_random_forest.py <plot_a3_peaks_pretrained_random_random_forest.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_a3_peaks_pretrained_random_random_forest.zip <plot_a3_peaks_pretrained_random_random_forest.zip>`
