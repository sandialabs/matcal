...
.. "surrogate_verification/plot_a2_peaks_fixed-sample_random_rbf.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_surrogate_verification_plot_a2_peaks_fixed-sample_random_rbf.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_surrogate_verification_plot_a2_peaks_fixed-sample_random_rbf.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    fixed-sample random-sampling RBF convergence summary:
...
.. image-sg:: /surrogate_verification/images/sphx_glr_plot_a2_peaks_fixed-sample_random_rbf_001.png
   :alt: Peaks verification: fixed-sample random-sampling RBF
   :srcset: /surrogate_verification/images/sphx_glr_plot_a2_peaks_fixed-sample_random_rbf_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (<Figure size 750x520 with 1 Axes>, <Axes: title={'center': 'Peaks verification: fixed-sample random-sampling RBF'}, xlabel='number of training samples', ylabel='validation error'>)
...
.. image-sg:: /surrogate_verification/images/sphx_glr_plot_a2_peaks_fixed-sample_random_rbf_002.png
   :alt: Peaks verification: fixed-sample random-sampling RBF, True Peaks function N=50, True Peaks function N=100, True Peaks function N=150, Absolute surrogate error N=50, field max=6.794e+00, Absolute surrogate error N=100, field max=5.962e+00, Absolute surrogate error N=150, field max=4.978e+00
   :srcset: /surrogate_verification/images/sphx_glr_plot_a2_peaks_fixed-sample_random_rbf_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Figures saved to: /gpfs/knkarls/projects/matcal_devel/external_matcal/documentation/surrogate_verification/paper_peaks_fixed-sample_random_rbf/figures
...
.. _sphx_glr_download_surrogate_verification_plot_a2_peaks_fixed-sample_random_rbf.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_a2_peaks_fixed-sample_random_rbf.ipynb <plot_a2_peaks_fixed-sample_random_rbf.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_a2_peaks_fixed-sample_random_rbf.py <plot_a2_peaks_fixed-sample_random_rbf.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_a2_peaks_fixed-sample_random_rbf.zip <plot_a2_peaks_fixed-sample_random_rbf.zip>`
