...
.. "introduction_examples/sierra_material_point_examples/plot_sierra_material_point_calibration_with_unloading.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_introduction_examples_sierra_material_point_examples_plot_sierra_material_point_calibration_with_unloading.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_introduction_examples_sierra_material_point_examples_plot_sierra_material_point_calibration_with_unloading.py:
...
.. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_001.png
   :alt: matcal_default_state
   :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_001.png
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_002.png
         :alt: plot sierra material point calibration with unloading
         :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_003.png
         :alt: plot sierra material point calibration with unloading
         :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_004.png
         :alt: plot sierra material point calibration with unloading
         :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_004.png
         :class: sphx-glr-multi-img
...
.. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_005.png
   :alt: plot sierra material point calibration with unloading
   :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_005.png
   :class: sphx-glr-single-img
...
.. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_006.png
   :alt: matcal_default_state
   :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_006.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_007.png
         :alt: plot sierra material point calibration with unloading
         :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_007.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_008.png
         :alt: plot sierra material point calibration with unloading
         :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_008.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_009.png
         :alt: plot sierra material point calibration with unloading
         :srcset: /introduction_examples/sierra_material_point_examples/images/sphx_glr_plot_sierra_material_point_calibration_with_unloading_009.png
         :class: sphx-glr-multi-img
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_sierra_material_point_calibration_with_unloading.ipynb <plot_sierra_material_point_calibration_with_unloading.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_sierra_material_point_calibration_with_unloading.py <plot_sierra_material_point_calibration_with_unloading.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_sierra_material_point_calibration_with_unloading.zip <plot_sierra_material_point_calibration_with_unloading.zip>`
