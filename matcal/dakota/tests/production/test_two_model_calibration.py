...
class MultiModelObjectiveTests(MatcalUnitTest):
    ...
    def test_two_models_multiple_states_datasets_and_objectives(self):
        ...
        param_1 = Parameter("param_1", 0, 10, 5)  # In MPa
        param_2 = Parameter("param_2", 0, 10, 5)
        ...
        mod2_dc = DataCollection("mod2", mod2_data_state_11, mod2_data_state_10, mod2_data_state_01, mod2_data_state_22, mod2_data_state_21)
        ...
        calibration.set_convergence_tolerance(1e-6)
    ...
    def test_lstsq_different_initial_guess(self):
        path = self.get_current_files_path(__file__)
        err_tol = .001

        param_1 = Parameter("param_1", 0, 10, 3)  # In MPa
        param_2 = Parameter("param_2", 0, 10, 7)
        parameter_collection = ParameterCollection("one_parameter", param_1, param_2)
