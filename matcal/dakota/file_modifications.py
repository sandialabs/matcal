...
def _check_pyprepro_delimiter_inputs(inline, code_block, code):
    check_value_is_nonempty_str(inline, "inline", call_depth=1)
    check_value_is_nonempty_str(code_block, "code_block", call_depth=1)
    check_value_is_nonempty_str(code, "code", call_depth=1)
