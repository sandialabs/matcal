...
from matcal.core.utilities import (
    matcal_name_format,
    check_valid_matcal_name_string,
    MatCalTypeStringError,
    MatcalNameFormatError,
    set_significant_figures,
    make_clean_dir,
    get_current_time_string,
    check_item_is_correct_type,
    check_value_is_positive,
...
class TestCheckValidMatCalNameString(MatcalUnitTest):
    ...
    def test_check_invalid_matcal_name_string(self):
        self.assert_error_type(
            MatCalTypeStringError, check_valid_matcal_name_string, "string_with_/"
        )
...
class TestInterpolateFieldsInTime(MatcalUnitTest):
    ...
    def test_explicit_missing_field_raises_key_error(self):
        ...
        with self.assertRaises(KeyError):
            interpolate_fields_in_time(ref_time, work_time, {}, fields=["missing"])
